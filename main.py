...
def start():
  ...
  if command in ("yes","Yes","Y","y"):
    ...
    if chance in ("yes","Yes","Y","y"):
      ...
      print("1.")
      time.sleep(0.3)
      Q2 = ["What is the National Sports of India? ==> a) Cricket b) Badminton c) Chess d) Hockey"]
      print(Q2[0:])
      ans = input("\nType Your Option a, b, c or d->")
      def ans2():
        while True:
    ...
    if chance in ("yes","Yes","Y","y"):
      ...
      print("1.")
      time.sleep(0.3)
      Q4 = ["What is the Total Union Territories in India? ==> a) 6 b) 8 c) 2 d) 11"]
      print(Q4[0:])
      ans = input("\nType Your Option a, b, c or d->")
      def ans4():
        while True:
    ...
    if chance in ("yes","Yes","Y","y"):
      ...
      print("1.")
      time.sleep(0.3)
      Q5 = ["What is Prime Minister of India? ==> a) Mr. Narendra Modi b) Mr. Shivraj Singh chouhan c) Mr. Amit Shah d) Mr. Udhav Thakre"]
      print(Q5[0:])
      ans = input("\nType Your Option a, b, c or d->")
      def ans5():
        while True:
